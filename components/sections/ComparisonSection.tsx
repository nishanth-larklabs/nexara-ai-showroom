          ...
          {(Object.keys(specLabels) as SpecKey[]).map((key, index) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`col-span-1 text-center text-sm font-semibold ${isDifferent ? "text-foreground" : "text-foreground/70"}`}
                >
                  {key === "safetyRating" ? `${valA} Stars` : valA}
                </div>
                <div
                  className={`col-span-1 text-center text-sm font-semibold ${isDifferent ? "text-primary" : "text-foreground/70"}`}
                >
